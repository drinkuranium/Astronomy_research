## 2020-03-10, Dong Uk Kim, plot_density_contour.py
## This code file stores implementations of plotting density contours using
## different Kernel functions (Gaussian, Cubic spline)
## Each function in this file can replace 'plot_density_contour' in an analysis.py
